...
<head>
    ...
    <title>Aplikasi Manajemen Surat-LSP</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <h3 class="font-weight-bold">APLIKASI MANAJEMEN SURAT-LSP</h3>
            </ul>
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                <b>Manajemen Informatika-PSDKU kediri</b>
            </div>
            Copyright &copy; 2023 | by : Novia-pkl
        </footer>
